class BusinessProfilesController < ApplicationController
  ...
  def leave
    @business_profile.users.delete(current_user) # we are deleting a current user from a list of users 
    redirect_to :back
  end
  ...
  def create
    ...
    @business_profile.users << current_user #the current user is being added to the list of users that are associate with 
